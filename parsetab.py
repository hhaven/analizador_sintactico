...
_lr_productions = [
  ...
  ('program -> program statement','program',2,'p_program','parse.py',13),
  ('program -> statement','program',1,'p_program','parse.py',14),
  ('statement -> variable_declaration','statement',1,'p_statement','parse.py',20),
  ('statement -> conditional_statement','statement',1,'p_statement','parse.py',21),
  ('statement -> function_call SEMICOLON','statement',2,'p_statement','parse.py',22),
  ('statement -> return_statement','statement',1,'p_statement','parse.py',23),
  ('statement -> function_declaration','statement',1,'p_statement','parse.py',24),
  ('return_statement -> RETURN expression SEMICOLON','return_statement',3,'p_return_statement','parse.py',29),
  ('return_statement -> RETURN SEMICOLON','return_statement',2,'p_return_statement','parse.py',30),
  ('variable_declaration -> TYPE ID SEMICOLON','variable_declaration',3,'p_variable_declaration','parse.py',35),
  ('conditional_statement -> IF LPAREN expression RPAREN compound_statement','conditional_statement',5,'p_conditional_statement','parse.py',41),
  ('conditional_statement -> IF LPAREN expression RPAREN compound_statement ELSE compound_statement','conditional_statement',7,'p_conditional_statement','parse.py',42),
  ('compound_statement -> LBRACE statement_list RBRACE','compound_statement',3,'p_compound_statement','parse.py',46),
  ('compound_statement -> LBRACE RBRACE','compound_statement',2,'p_compound_statement','parse.py',47),
  ('expression -> STRING','expression',1,'p_expression','parse.py',57),
  ('expression -> ID','expression',1,'p_expression','parse.py',58),
  ('expression -> NUMBER','expression',1,'p_expression','parse.py',59),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression','parse.py',60),
  ('expression -> expression PLUS expression','expression',3,'p_expression','parse.py',61),
  ('expression -> expression MINUS expression','expression',3,'p_expression','parse.py',62),
  ('expression -> expression TIMES expression','expression',3,'p_expression','parse.py',63),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression','parse.py',64),
  ('expression -> expression LT expression','expression',3,'p_expression','parse.py',65),
  ('expression -> expression LE expression','expression',3,'p_expression','parse.py',66),
  ('expression -> expression GT expression','expression',3,'p_expression','parse.py',67),
  ('expression -> expression GE expression','expression',3,'p_expression','parse.py',68),
  ('expression -> expression EQ expression','expression',3,'p_expression','parse.py',69),
  ('expression -> expression NE expression','expression',3,'p_expression','parse.py',70),
  ('function_call -> ID LPAREN argument_list RPAREN','function_call',4,'p_function_call','parse.py',76),
  ('function_call -> ID LPAREN RPAREN','function_call',3,'p_function_call','parse.py',77),
  ('function_declaration -> TYPE ID LPAREN argument_list RPAREN LBRACE statement_list RBRACE','function_declaration',8,'p_function_declaration','parse.py',81),
  ('function_declaration -> TYPE ID LPAREN RPAREN LBRACE statement_list RBRACE','function_declaration',7,'p_function_declaration','parse.py',82),
  ('argument_list -> argument_list COMMA expression','argument_list',3,'p_argument_list','parse.py',87),
  ('argument_list -> expression','argument_list',1,'p_argument_list','parse.py',88),
  ('statement_list -> statement_list statement','statement_list',2,'p_statement_list','parse.py',93),
  ('statement_list -> statement','statement_list',1,'p_statement_list','parse.py',94),
]
